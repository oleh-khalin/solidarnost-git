...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const mainImage = document.querySelector('.promotions-single-image');
    const more = document.querySelector('.promotions-single-more');
    ...
    new Glide('.promotions-single-glide', {
        type: 'carousel',
        startAt: 0,
        perView: 2,
        gap: 32,
